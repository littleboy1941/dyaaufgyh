...
**Статус проверки на 2026-09-20:** реклама в каналах по первому впечатлению не показывается — проверено бегло, глазами, без обхода всех поверхностей. Была ложная тревога: пользователь прислал скриншот с рекламой, но это оказался обычный Telegram, а не наша сборка. **Не проверено ничего остального из чек-листа ниже:** превью ссылок и, главное, отправляется ли сообщение со ссылкой; спонсорские результаты поиска; строка над списком чатов; «похожие каналы»; секунды у времени; обратное выключение тумблеров.
