...
Состояние на 2026-09-18. Это форк официального Telegram-iOS с фичами AyuGram, который собирается без Mac на GitHub Actions и ставится на iPhone через SideStore с бесплатным Apple ID.
...
- run 35311478118 — снятие ограничений на скриншоты/запись/пересылку (коммит 317d0363). Debug, кэш подхватился, вся сборка **1 ч 16 мин** — совпадает с замером «новый public API TelegramCore ≈ 1 ч 20 мин». IPA 524 МБ. **Актуальная сборка.**
