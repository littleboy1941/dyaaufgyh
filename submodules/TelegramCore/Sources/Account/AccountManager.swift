...
private var declaredEncodables: Void = {
    ...
    declareEncodable(TelegramCommunity.self, f: { TelegramCommunity(decoder: $0) })
    ...
    declareEncodable(CachedCommunityData.self, f: { CachedCommunityData(decoder: $0) })
    ...
    declareEncodable(AyuDeletedMessageAttribute.self, f: { AyuDeletedMessageAttribute(decoder: $0) })
