                        ...
                        for id in removedMessageIds {
                            if !validMessageIds.contains(id) {
                                if let tag = tag {
                                    ...
                                    // AyuGram: a message the server no longer has may be kept as deleted
                                    if !ayuMarkMessageDeleted(transaction: transaction, id: id, settings: ayuSettings(transaction: transaction), timestamp: ayuCurrentTimestamp()) {
